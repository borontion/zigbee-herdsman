...
= {
    ...
    cncRealtime: {
        ...
        attributes: {
            ...
            cncRealtimeProgram: {ID: 1, type: DataType.charStr},
            cncRealtimeLine: {ID: 2, type: DataType.uint32},
            cncRealtimeRuntime: {ID: 3, type: DataType.uint32},
            cncRealtimeCuttime: {ID: 4, type: DataType.uint32},
            cncRealtimeGMode: {ID: 5, type: DataType.charStr},
            cncRealtimeMMode: {ID: 5, type: DataType.charStr},
            cncRealtimeSpindle: {ID: 16, type: DataType.charStr},
            cncRealtimeCoord: {ID: 17, type: DataType.charStr},
            cncRealtimeFeed: {ID: 18, type: DataType.charStr},
